...
class Department(models.Model):
    ...
    HOD_featured_image = models.ImageField(max_length=255, blank=True, null=True)
    department_featured_image = models.ImageField(max_length=255, blank=True, null=True)
...
class Team_Member(models.Model):
    ...
    contact = models.IntegerField(max_length=30, blank=True, null=True)
